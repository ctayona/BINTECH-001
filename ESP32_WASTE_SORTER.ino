...
const String BACKEND_URL = "http://192.168.254.119:3000"; // Change to your Node.js server IP  http://192.168.254.105:3000  http://192.168.254.113:3000
...
const int VERIFICATION_RANGE = 10 ;
const int OCCUPANCY_DETECTION_RANGE = 10;
